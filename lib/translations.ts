...
export const translations = {
  de: {
    ...
    feature1Desc: 'EPG-Daten für über 40 Länder weltweit: Deutschland, USA, UK, Frankreich, Italien, Spanien, Brasilien, Indien, Japan und viele mehr',
  ...
  en: {
    ...
    feature1Desc: 'EPG data for over 40 countries worldwide: Germany, USA, UK, France, Italy, Spain, Brazil, India, Japan and many more',
  ...
  fr: {
    ...
    feature1Desc: 'Données EPG pour plus de 40 pays dans le monde: Allemagne, États-Unis, Royaume-Uni, France, Italie, Espagne, Brésil, Inde, Japon et bien d\'autres',
